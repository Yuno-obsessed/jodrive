...
insert into metadata_db.users (id, username, email, password, subscription_id, created_at, updated_at) values ('29849880-ddd4-4000-b100-460f4c505045', 'anonymous', 'anon@gmail.com', 'admin', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
